...
export function SobreNosCard({ titulo, icone, texto }: SobreNosCardProps) {
  return (
    <div className="flex items-center w-full sm:w-auto md:my-0 sm:my-10">
      <div className="flex items-center border border-text-color shadow-text-color shadow-2xl rounded-lg w-full sm:w-70 bg-white">
          ...
          <div className="p-3 sm:p-4 flex-1">
            <div className="flex items-center justify-between mb-2">
              ...
              <Icon icon={icone} className="inline-block text-secondary w-8 h-8 sm:w-10 sm:h-10 p-0 m-0 shrink-0" />
            </div>
